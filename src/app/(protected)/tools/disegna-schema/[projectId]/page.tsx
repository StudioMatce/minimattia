...
import { saveSketch, saveTextPromptSketch } from "@/app/(protected)/tools/disegna-schema/actions";
...
export default function ProjectCanvasPage() {
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      toast.success("Visual generato!", { id: toastId });
      router.push(`/tools/disegna-schema/${params.projectId}/generated`);
    } catch (err) {
      const message =
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        <HistorySidebar
          history={history}
          basePath={`/tools/disegna-schema/${params.projectId}/generated`}
        />
