...
export default async function GeneratedPage({ params, searchParams }: Props) {
  ...
  if (!visual) {
    redirect(`/tools/disegna-illustrazione/${projectId}`);
  }
  ...
  const basePath = `/tools/disegna-illustrazione/${projectId}/generated`;

  return (
    <div className="flex h-full flex-col">
      {/* Top bar */}
      <div className="flex items-center justify-between border-b px-4 py-2 min-h-[49px]">
        <Link href={`/tools/disegna-illustrazione/${projectId}`}>
